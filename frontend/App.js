...
import { WordKnowledgeProvider } from './src/context/WordKnowledgeContext';
import CustomAlert, { showCustomAlert } from './src/components/CustomAlert';

// Global override for native React Native alerts
Alert.alert = (title, message, buttons) => {
  showCustomAlert(title, message, buttons);
};

// Enforce native splash screen visibility during cold startup
