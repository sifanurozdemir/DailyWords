...
export default function LoginScreen({ navigation }) {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={[styles.container, { backgroundColor: COLORS.bg_primary }]}>
            <StatusBar barStyle={isDark ? 'light-content' : 'dark-content'} />
            <View style={[styles.card, { backgroundColor: theme.card, shadowColor: theme.shadow }]}>
                <Text style={[styles.logo, { color: COLORS.accent_violet }]}>DailyWords</Text>
                <Text style={[styles.subtitle, { color: COLORS.text_secondary }]}>İngilizce öğrenmeye başla</Text>

                <TextInput
                    style={[styles.input, { backgroundColor: COLORS.bg_input, borderColor: COLORS.border, color: COLORS.text_primary }]}
                ...
                <View style={[styles.passwordContainer, { backgroundColor: COLORS.bg_input, borderColor: COLORS.border }]}>
                    <TextInput
                ...
                <TouchableOpacity 
                    style={[styles.button, { backgroundColor: loading ? COLORS.accent_purple + '22' : COLORS.accent_purple }]} 
                    onPress={handleLogin} 
                    activeOpacity={0.8}
                    disabled={loading}
                >
...
const styles = StyleSheet.create({
    ...
    buttonText: { color: COLORS.text_primary, fontSize: 17, fontWeight: 'bold' },
