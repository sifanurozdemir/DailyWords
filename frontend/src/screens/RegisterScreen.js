...
export default function RegisterScreen({ navigation }) {
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <Text style={[styles.title, { color: COLORS.accent_violet }]}>Yeni Hesap Oluştur</Text>
            <Text style={[styles.subtitle, { color: COLORS.text_secondary }]}>DailyWords ile İngilizce yolculuğuna başla.</Text>
            ...
            <TextInput 
                style={[styles.input, { backgroundColor: COLORS.bg_input, borderColor: COLORS.border, color: COLORS.text_primary, marginBottom: 5 }]}
                placeholder="Şifre" 
                placeholderTextColor={theme.textMuted}
                secureTextEntry 
                value={password} 
            ...
            <TouchableOpacity style={[styles.button, { backgroundColor: loading ? COLORS.accent_purple + '22' : COLORS.accent_purple }]} onPress={handleRegister} disabled={loading}>
...
const styles = StyleSheet.create({
    ...
    buttonText: { color: COLORS.text_primary, fontSize: 18, fontWeight: 'bold' },
    link: { marginTop: 25 },
