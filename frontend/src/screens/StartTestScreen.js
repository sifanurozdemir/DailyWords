    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <TouchableOpacity 
                    style={[styles.btn, { backgroundColor: COLORS.accent_purple, shadowColor: COLORS.accent_purple }]} 
...
const styles = StyleSheet.create({
    ...
    btnText: { color: COLORS.text_primary, fontSize: 19, fontWeight: '800', letterSpacing: 1 },
