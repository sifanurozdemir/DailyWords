            ...
            <View style={styles.content}>
                ...
                <View style={[styles.infoCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                    ...
                    <View style={styles.instructionRow}>
                        <Ionicons name="arrow-forward-circle" size={30} color={COLORS.game_correct} />
                        <Text style={[styles.instructionText, { color: theme.text }]}>DOĞRU ise SAĞA kaydır</Text>
                    </View>
                    
                    <View style={styles.instructionRow}>
                        <Ionicons name="arrow-back-circle" size={30} color={COLORS.game_wrong} />
                ...
                >
                    ...
                    <Ionicons name="play" size={20} color={COLORS.text_primary} style={{ marginLeft: 5 }} />
                </TouchableOpacity>
            </View>
        </View>
    );
