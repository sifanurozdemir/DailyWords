...
# Excel dosyasını ana proje klasöründe arar
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
file_path = os.path.join(os.path.dirname(BASE_DIR), "datasetKelime.xlsx")
...
def seed_data():
    ...
    # Ses klasörü yolu (Ana proje dizini içinde assets/audio)
    audio_folder = os.path.join(os.path.dirname(BASE_DIR), "assets", "audio")
    ...
    for index, row in df.iterrows():
        try:
            ...
            full_audio_path = os.path.join(os.path.dirname(BASE_DIR), relative_audio_path)
